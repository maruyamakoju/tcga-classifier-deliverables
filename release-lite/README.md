...
[![Release](https://img.shields.io/github/v/release/maruyamakoju/tcga-classifier-deliverables?display_name=tag)](https://github.com/maruyamakoju/tcga-classifier-deliverables/releases/tag/v2.4.0-gdc-starcounts)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Citation](https://img.shields.io/badge/citation-CITATION.cff-blue.svg)](CITATION.cff)

Release: `v2.4.0-gdc-starcounts` (`2026-07-12`; public scoring-library API
...
and run manifests. A post-fix live re-validation later re-fetched all three
external cohorts — CPTAC-3 (GDC Data Release 45.0) and TCGA-Toil / GTEx normals
(UCSC Xena) — and reproduced their committed metrics (CPTAC AUC 0.9886, Toil AUC
0.9923, GTEx FPR 0.996); see `external-validation/REVALIDATION.md`.
